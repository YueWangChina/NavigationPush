...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of NavigationPush.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/454431208@qq.com/NavigationPush'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '454431208@qq.com' => 'wangyuexdy@163.com' }
  s.source           = { :git => 'https://github.com/454431208@qq.com/NavigationPush.git', :tag => s.version.to_s }
